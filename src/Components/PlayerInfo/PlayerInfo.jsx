            ...
            <div className="container">
                <Grid>
                    <Row className="show-grid">
                        ...
                        <Col xs={2} md={3} className="text-left">{this.props.player}</Col>
                    </Row>

                    <Row className="show-grid">
                        <Col xs={1} md={2} className="text-right"><strong>Total Value:</strong></Col>
                        <Col xs={2} md={3} className="text-left">{this.props.totalValue}</Col>
                    </Row>

                    <Row className="show-grid">
                        <Col xs={1} md={2} className="text-right"><strong>Total Area:</strong></Col>
                        <Col xs={2} md={3} className="text-left">{this.props.totalArea}</Col>
                    </Row>
                </Grid>
            </div>
        );
